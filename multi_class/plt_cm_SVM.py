...
plt.savefig(result_path+"loocv_cm_svm_multiclass.jpg", format='jpg', dpi=300)
plt.savefig(result_path+"loocv_cm_svm_multiclass.eps", format='eps', dpi=300)
...
plt.savefig(result_path+"roc_svm_multiclass.jpg.jpg", format='jpg', dpi=300)
plt.savefig(result_path+"roc_svm_multiclass.eps", format='eps', dpi=300)
plt.show()
