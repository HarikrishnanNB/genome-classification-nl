...
Confusion Matrix Plot for Neurochaos Learning
"""
import os
import numpy as np
...
lw = 3
plt.plot(fpr['micro'], tpr['micro'], color="red", lw=lw, label="ROC curve (area = %0.2f)" % roc_auc[2],)
...
# plt.savefig(result_path+"roc_chaosfex_svm.jpg", format='jpg', dpi=300)
# plt.savefig(result_path+"roc_chaosfex_svm.eps", format='eps', dpi=300)
plt.show()
