...
Confusion Matrix plot for NL for LOOCV
"""
import os
import numpy as np
...
plt.savefig(result_path+"/loocv_cm_chaosfex_svm_binaryclass.jpg", format='jpg', dpi=300)
plt.savefig(result_path+"loocv_cm_chaosfex_svm_binaryclass.eps", format='eps', dpi=300)
...
plt.savefig(result_path+"roc_chaosfex_svm_binaryclass.jpg", format='jpg', dpi=300)
plt.savefig(result_path+"roc_chaosfex_svm_binaryclass.eps", format='eps', dpi=300)
plt.show()
